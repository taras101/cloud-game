...
PhaserGame.prototype = {
    ...
    create: function () {
        ...
        // Diamond
        this.diamond = this.add.physicsGroup();
        ...
        this.stationary.create(632, 120, 'platform');
        this.stationary.create(1100, 330, 'platform');
        this.stationary.create(1540, 250, 'platform');
        this.stationary.create(1900, 150, 'platform');
        this.stationary.create(1900, 350, 'platform');
        this.stationary.create(2220, 200, 'platform');
        this.stationary.create(2400, 124, 'platform');
        ...
        cloud1.addMotionPath([
            { x: "+200", xSpeed: 1000, xEase: "Linear", y: "-200", ySpeed: 1000, yEase: "Sine.easeIn" },
            { x: "-200", xSpeed: 1000, xEase: "Linear", y: "-200", ySpeed: 1000, yEase: "Sine.easeOut" },
        ...
        cloud2.addMotionPath([
            ...
            { x: "-0", xSpeed: 500, xEase: "Linear", y: "-300", ySpeed: 500, yEase: "Linear" }
        ]);

        var cloud3 = new CloudPlatform(this.game, 1300, 290, 'cloud-platform', this.clouds);

        cloud3.addMotionPath([
            { x: "+450", xSpeed: 4000, xEase: "Expo.easeIn", y: "-200", ySpeed: 3000, yEase: "Linear" },
    ...
    update: function () {
        ...
        this.physics.arcade.overlap(this.player, this.diamond, hitDiamond, null, this);
